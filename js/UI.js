...
_getUpdateHelpContent() {
  return `
      ...
      <h4>v1.1.2 최신 업데이트(25.12.08):</h4>
      <ul>
        <li>밴드 채팅 내보내기 형식 호환성 개선
          <ul>
            <li>기존 형식: "2025년 12월 8일 오후 10:54:사용자명:메시지"</li>
            <li>새 형식: "2025년 12월 8일 오후 10:54 사용자명 메시지"</li>
            <li>두 가지 형식 모두 자동 인식 및 파싱</li>
          </ul>
        </li>
      </ul>
      
      <h4>v1.1.1 이전 업데이트(25.03.13):</h4>
      <ul>
